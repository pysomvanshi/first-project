...
doc_events = {
	"User": {
		"after_insert": "meeting.meeting.doctype.meeting.meeting.make_orientation_meeting"
	},
	"ToDo": {
		"on_update": "meeting.meeting.doctype.meeting.meeting.update_minute_status",
		"on_trash": "meeting.meeting.doctype.meeting.meeting.update_minute_status"
	}
}
